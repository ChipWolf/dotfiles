# Generated by Powerlevel10k configuration wizard on 2026-02-25 at 15:33 GMT.
...
# Apply Catppuccin Mocha color palette
...
() {
  ...
  # Current directory background color.
   typeset -g POWERLEVEL9K_DIR_BACKGROUND=$P10K_COLOR_RED
